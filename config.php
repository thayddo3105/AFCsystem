...
define('CONTACTFORM_FROM_ADDRESS', 'afcsystem385666@gmail.com');
define('CONTACTFORM_FROM_NAME', 'AFC System');
...
// define('CONTACTFORM_TO_NAME', "$nome");

// The details of your SMTP service, e.g. Gmail.
define('CONTACTFORM_SMTP_HOSTNAME', 'smtp.gmail.com');
define('CONTACTFORM_SMTP_USERNAME', 'afcsystem385666@gmail.com');
define('CONTACTFORM_SMTP_PASSWORD', 'xahhrrkuvjurvsvl');
